...
RATE_LIMITING_MESSAGE=process.env.SURESPOT_RATE_LIMITING_MESSAGE ? false
RATE_LIMITING_PING=process.env.SURESPOT_RATE_LIMITING_PING ? false
RATE_LIMITING_EXISTS=process.env.SURESPOT_RATE_LIMITING_EXISTS ? false
RATE_LIMITING_CREATE_USER=process.env.SURESPOT_RATE_LIMITING_CREATE_USER ? false
